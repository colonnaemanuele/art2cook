...
IMG_PROJ_LAYER_WEIGHTS = PROJ_DIR + "/art2mus_weights/art2mus_4_img_proj_layer.pt"
...
class AudioLDM2Pipeline(DiffusionPipeline):
    ...
    def encode_prompt(
        ...
        if prompt_attention_mask is not None and img_attention_mask is not None:
            attention_mask = torch.cat([prompt_attention_mask, img_attention_mask], dim=1)
        elif prompt_attention_mask is not None and img_attention_mask is None:
    ...
    def __encode_artwork_no_t5__(self, artwork_embeds, batch_size, device):
        ...
        proj_img_att_mask = torch.ones((batch_size, 4))
